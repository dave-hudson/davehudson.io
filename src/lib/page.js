...
export function pageHeader() {
    const component = () => h('header', { className: 'header' }, h('nav', { className: 'site-title' }, h('a', { className: 'home-link', href: '/', onClick: (e) => navigateEvent(e, '/') }, 'davehudson.io'), h('a', { className: 'icon', href: 'https://instagram.com/davehudsonio', title: 'Instagram' }, instagramIcon()), h('a', { className: 'icon', href: 'https://x.com/davehudsonio', title: 'X' }, xIcon()), h('a', { className: 'icon', href: 'https://linkedin.com/in/davejh', title: 'LinkedIn' }, linkedInIcon()), h('a', { className: 'icon', href: 'https://github.com/dave-hudson', title: 'GitHub' }, gitHubIcon()), h('a', {
        className: 'icon',
        href: 'mailto:hello@davehudson.io?subject=Email\ about\ davehudson.io',
        title: 'Email'
    }, mailIcon())), h('nav', { className: 'site-menu' }, h('a', { className: 'menu', href: '/blog', onClick: (e) => navigateEvent(e, '/blog') }, 'Blog'), h('a', { className: 'menu', href: '/projects', onClick: (e) => navigateEvent(e, '/projects') }, 'Projects'), h('a', { className: 'menu', href: '/about', onClick: (e) => navigateEvent(e, '/about') }, 'Me'), sunMoonIcon(false, setDarkTheme), sunMoonIcon(true, setDarkTheme)));
...
export function pageFooter() {
    return h('footer', { className: 'footer' }, h('p', { className: 'copyright' }, '© 2014-2024 David J. Hudson'));
}
