...
function blogOpening_2016_02_03(): VNode[] {
    return [
        h('p', {},
...
function blogArticle_2016_02_03(): VNode[] {
    return [
        h('section', {},
        ...
        h('section', {},
            ...
            h('figure', {},
                h('img', {
                    src: '/blog/2016-02-03/fees-per-tx-btc.png',
            ...
            h('figure', {},
                h('img', {
                    src: '/blog/2016-02-03/tx-per-day.png',
            ...
            h('figure', {},
                h('img', {
                    src: '/blog/2016-02-03/fees-per-tx-usd.png',
        ...
        h('section', {},
            ...
            h('figure', {},
                h('img', {
                    src: '/blog/2016-02-03/rewards-per-tx-usd.png',
...
export const blogPost_2016_02_03 = new BlogPost(
    ...
    '/blog/2016-02-03/fees-per-tx-btc.png',
    null,
    blogOpening_2016_02_03,
    blogArticle_2016_02_03,
    null
);
