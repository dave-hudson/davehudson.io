...
function blogOpening_2014_03_12(): VNode[] {
    return [
        h('p', {},
...
function blogArticle_2014_03_12(): VNode[] {
    return [
        h('p', {}, 'Let\'s look at the graph:'),
        h('figure', {},
            h('img', {
                src: '/blog/2014-03-12/20140312_BTC_Price.png',
...
export const blogPost_2014_03_12 = new BlogPost(
    'Strange spikes in the Bitcoin price',
    '2014-03-12',
    '/blog/2014-03-12',
    'There are strange periodic spikes in the Bitcoin price.  This blog post looks at them.',
    '/blog/2014-03-12/20140312_BTC_Price.png',
    null,
    blogOpening_2014_03_12,
    blogArticle_2014_03_12,
    null
);
