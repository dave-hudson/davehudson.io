...
function blogOpening_2014_06_05(): VNode[] {
    return [
        h('p', {},
...
function blogArticle_2014_06_05(): VNode[] {
    return [
        h('p', {}, 'Let\'s look at the graph (plotted on a logarithmic Y axis):'),
        h('figure', {},
            h('img', {
                src: '/blog/2014-06-05/BTC-price.png',
...
function blogPostScript_2014_06_05(): VNode[] {
    return [
        h('hr', {}),
        h('section', {},
...
export const blogPost_2014_06_05 = new BlogPost(
    'Strange spikes revisited!',
    '2014-06-05',
    '/blog/2014-06-05',
    'This blog post revisits the strange spikes in the Bitcoin price that we looked at previously.',
    '/blog/2014-06-05/BTC-price.png',
    null,
    blogOpening_2014_06_05,
    blogArticle_2014_06_05,
    blogPostScript_2014_06_05
);
