    ...
    return [
        h('section', {},
            ...
            h('p', {},
                ...
                'estimated statistics look like for 24 hours.  We\'ll start by considering what happens when there\'s no expansion ' +
                'occurring in the network.  Here\'s what we find from a Monte Carlo simulation with 10M trials:'
            ),
            h('figure', {},
            ...
            h('p', {},
                'One curious thing is to note that around the 50% level we see the cumulative statistics actually become a little ' +
                '"blocky" but that\'s because there turn out to be a limited number of values that can occur.'
            ),
            h('p', {},
                ...
                'or more.  In practice if we\'re not seeing more than 50% every other day then the pool we\'re looking at probably ' +
                'doesn\'t really have at least half of the network hash rate; an odd day above is really not as interesting.'
            ),
            h('p', {},
            ...
            h('p', {},
                'The 2% per day hash rate expansion is pretty extreme, corresponding to a difficulty change of 24.8% on average, ' +
                'but this doesn\'t actually make much difference.  Our "once in ten days" metric now has ranges of 43.5% or less ' +
                'and 56.4% and greater.'
            )
        ),
        h('section', {},
            ...
            h('p', {},
                'Even over 2016 blocks (14 days on average) we can see quite a lot of variability in the measured hash rates.  One ' +
                'difficulty change in five we\'ll see a discrepancy in the estimated pool hash rate of more than +/- 1.4%.'
            )
        ),
        h('section', {},
            h('h2', {}, 'Final thoughts'),
            h('p', {},
                ...
                'any 24 hour period before that alone is sufficient to say that the pool has achieved 50% of the network hash rate.'
            ),
            h('p', {},
