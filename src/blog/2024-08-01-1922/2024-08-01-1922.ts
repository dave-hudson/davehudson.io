...
function blogPrompt_2024_08_01_1922(): VElement {
    ...
    contents.mountCallback = () => {
        ...
        if (code[0].length === 0) {
            loadFile(0, '/blog/2024-08-01-1922/2024-08-01-1922-prompt.txt', writeCode);
        }
    }
...
function blogCode_2024_08_01_1922(): VElement {
    let contents: VElement;
    if (code[1].length === 0) {
        contents = h('pre', {});
    } else {
    ...
    contents.mountCallback = () => {
        ...
        if (code[1].length === 0) {
            loadFile(1, '/blog/2024-08-01-1922/2024-08-01-1922-code.ts', writeCode);
        }
    }
    ...
    return [
        h('section', {},
            ...
            h('section', {},
                h('h2', {}, 'Source code'),
                h('p', {},
                    'The source code for the siterender project can be found on github: ',
...
export const blogPost_2024_08_01_1922 = new BlogPost(
    'ChatGPT: changing the rules of software development',
    '2024-08-01T19:22',
    '/blog/2024-08-01-1922',
    'Generative AI has huge potential to change the way we build software, but it will need new techniques to get the ' +
    'best from it.  Here\'s one such approach.',
